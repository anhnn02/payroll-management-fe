...
> **Updated from source code**: 2026-03-24  
...
| Attendance | PUT | `/api/v1/attendance/monthly/{empId}` | Query `month`, body `AttendanceMonthlyUpdateRequest` | `SuccessResponse<Void>` |
...
| Config | POST | `/api/v1/config/holidays` | `HolidayRequest` | `SuccessResponse<HolidayResponse>` |
...
| Reports | GET | `/api/v1/reports/dashboard-pyc` | Query `month?` | `SuccessResponse<DashboardPycResponse>` |
...
- `DepartmentSearchRequest`: `code`, `name`, `status`, `page`, `size`, `sort`
- `PositionRequest`: `code`, `name`, `description`, `level`, `status`
- `PositionSearchRequest`: `code`, `name`, `level`, `status`, `page`, `size`, `sort`
- `EmployeeRequest`: `code`, `name`, `dob`, `gender`, `deptId`, `positionId`, `hireDate`, `status`
- `EmployeeSearchRequest`: `keyword`, `code`, `name`, `deptIds[]`, `positionIds[]`, `status`, `gender`, `page`, `size`, `sort`
- `ContractRequest`: `contractNumber`, `empId`, `startDate`, `endDate`, `salaryType`, `baseSalary`, `offerSalary`, `factorId`, `contractType`, `status`, `terms`
- `ContractSearchRequest`: `contractNumber`, `empId`, `status`, `startDateFrom`, `startDateTo`, `page`, `size`, `sort`
- `AttendanceRequest`: `empId`, `attendanceDate`, `startTime`, `endTime`, `lunchBreakHours`, `workHours`, `normalHours`, `otHours`, `isWorkingDay`, `otType`, `note`
- `AttendanceSearchRequest`: `month`, `keyword`, `deptId`, `empId`, `dateFrom`, `dateTo`, `page`, `size`, `sort`
- `AttendanceMonthlyUpdateRequest`: `workDays`, `otHours`, `leaveApproved`, `leaveUnauthorized`
- `PayrollCalculateRequest`: `employeeCode`, `monthYear`
- `PayrollSearchRequest`: `empId`, `status`, `monthNum`, `yearNum`, `page`, `size`, `sort`
- `SalaryPaymentRequest`: `monthNum`, `yearNum`, `paymentDate`, `approvedBy`, `note`
- `SalaryPaymentSearchRequest`: `monthNum`, `yearNum`, `approvedBy`
- `SalaryFactorConfigRequest`: `code`, `name`, `value`
...
- `EmployeeResponse`: `id`, `code`, `name`, `dob`, `gender`, `deptId`, `positionId`, `hireDate`, `status`, `createdBy`, `createdAt`, `updatedBy`, `updatedAt`
- `ContractResponse`: `id`, `contractNumber`, `empId`, `startDate`, `endDate`, `salaryType`, `baseSalary`, `offerSalary`, `factorId`, `contractType`, `status`, `fileUrl`, `terms`, `createdBy`, `createdAt`, `updatedBy`, `updatedAt`
- `AttendanceResponse`: `id`, `empId`, `attendanceDate`, `startTime`, `endTime`, `lunchBreakHours`, `workHours`, `normalHours`, `otHours`, `isWorkingDay`, `otType`, `note`, `createdBy`, `createdAt`, `updatedBy`, `updatedAt`
...
- `PayrollResponse`: `id`, `empId`, `monthNum`, `yearNum`, `basicSalary`, `offerSalary`, `workingDays`, `standardDays`, `allowance`, `rewardAmount`, `penaltyAmount`, `otHours`, `otSalary`, `bhxhAmount`, `bhtnAmount`, `bhytAmount`, `taxAmount`, `totalSalary`, `grossNet`, `status`, `calculatedAt`, `calculatedBy`
- `SalaryPaymentCreateResponse`: `paymentCount`, `createdIds[]`
...
- `DashboardPycResponse`: `month`, `alerts[]`, `kpis`, `charts`, `quickLinks[]`
