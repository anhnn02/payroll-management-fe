...
const loadEmployees = async () => {
  ...
  try {
    ...
    // Lọc NV chưa có vị trí hoặc không phải vị trí hiện tại
    employees.value = (response.content || []).filter(
      emp => !emp.positionId || emp.positionId !== props.positionId
    )
  } catch {
    employees.value = []
  } finally {
...
<template>
  <el-dialog
    ...
    title="Thêm nhân viên vào vị trí"
    width="680px"
  ...
  >
    ...
    >
      ...
      <el-table-column prop="deptName" label="Phòng ban" width="150" />
